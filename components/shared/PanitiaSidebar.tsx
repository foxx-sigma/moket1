...
import { ScanLine, User, Video, LogOut, Menu, X } from "lucide-react";
import { Button } from "@/components/ui/button";
import Image from "next/image";

const sidebarLinks = [
  { href: "/panitia/scanner", label: "QR Scanner", icon: ScanLine },
  { href: "/panitia/zoom", label: "Zoom Meeting", icon: Video },
  { href: "/panitia/profile", label: "Profil", icon: User },
];
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background border-b border-border z-50 flex items-center justify-between px-4">
        <Link href="/panitia/scanner" className="flex items-center gap-2">

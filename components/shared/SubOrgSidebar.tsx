...
const sidebarLinks = [
  ...
  { href: "/sub-org/events", label: "Event Saya", icon: CalendarDays },
  { href: "/sub-org/profile", label: "Profil Organisasi", icon: Building2 },
];
  ...
  return (
    <>
      ...
      <aside
        ...
        } lg:translate-x-0 fixed lg:sticky top-0 left-0 z-40 w-64 h-screen bg-card border-r border-border transition-transform duration-300 lg:flex lg:flex-col pt-16 lg:pt-0`}
      >
        {/* Logo + role badge */}
